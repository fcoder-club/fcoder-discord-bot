...
async function getData(country) {
    ...
    return axios(API_URL + reqPath, {validateStatus: false});
}
...
async function render(data) {
    ...
    cases = cases ?? (deaths + active + recovered);
    ...
    let svg = await readFile(join(__dirname, "ncov.svg"), {encoding: "utf-8"}) || "";
    svg = placeholder(svg, placeholders);
    return s2i(svg, {
        width: 1790,
        height: 768
    })
